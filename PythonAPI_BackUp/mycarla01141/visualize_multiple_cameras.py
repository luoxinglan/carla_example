...
# UPDATE0114：固定到车辆
from car_tracker import find_hero_vehicle
...
def run_simulation(args, client):
    ...
    try:
        ...
        if not vehicle:
            ...
            bp = world.get_blueprint_library().filter('model3')[0]#修改了车辆
            # print(bp)
            ...
            print(f"Spawned new hero vehicle: {vehicle.id}")
        else:
            print(f"Found existing hero vehicle: {vehicle.id}")
